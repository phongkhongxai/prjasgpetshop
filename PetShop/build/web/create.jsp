<%-- 
    Document   : create
    Created on : Jul 9, 2023, 3:39:07 PM
    Author     : truon
--%>
        ...
        <div class="login-box">
            ...
            <form action="RegisterController" method="post">
                ...
                <div style="text-align: center;">
                    <button style="margin-top: 0;border: 0; " type="submit">Sign up</button>
                    <span></span>
                </div>


            </form>
            <span class="span"><div style="text-align: center; margin-top: 10px">Back to <a href="login.jsp">Login</a></div></span>
        </div>
    </body>
</html>
