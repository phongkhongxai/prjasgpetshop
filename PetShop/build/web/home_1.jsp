...
<html>
    ...
    <body>
        <nav style="background-color:#ff9933"    class="navbar navbar-expand-md">
            <div class="container">
                <a class="navbar-brand" href="LoadController2"><img style="width: 65px; height: 65px" src="logo.jpg"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="">
                            <c:if test="${not empty login_user}">
                                <a class="" href="ManagerController">Manager Shop</a>
                            </c:if>
                        </li>
                        <li class="">
                            <form action="SearchController" method="get">
                                ...
                                <div class="containe">
                                    <input style="background-color:white" value="${txs}" type="text" class="inpu" name="search" placeholder="Search...">
